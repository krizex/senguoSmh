...
var notice = '<div class="wrap-item-box pm10">'+
    '<div class="inform-item">'+
    '<span class="fr c999">{{time}}</span>'+
    '<img src="{{imgurl}}" alt="用户头像" class="inform-img"/>'+
    '<span class="c333 ml4">{{name}}</span>'+
    '<span class="ml4 c999">{{com_type}}了</span>'+
    '</div>'+
    '<a href="/bbs/detail/{{id}}" class="c333 mt4 f14 article-name">{{title}}</a>'+
    '<p class="c999 inform-txt">{{detail}}</p>'+
    '</div>';

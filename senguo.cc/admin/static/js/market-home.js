    ...
    $.postJson(url,args,function(res){
        if(res.success)
        {
            ...
            if(window.dataObj.goods_item==undefined){
                getItem('/static/items/customer/market-goods-item.html?v=20160608',function(data){
                    window.dataObj.goods_item=data;
                    getItem('/static/items/customer/charge-item.html?v=20160608',function(data){
                        window.dataObj.charge_item=data;
                        getItem('/static/items/customer/classify_item.html?v=20160608',function(data){

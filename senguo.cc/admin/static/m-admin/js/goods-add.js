    ...
    var uploader = Qiniu.uploader({
        ...
        init: {
            'FilesAdded': function (up, files) {
                ...
                var w = width+10;
                var $item = $('<li style="width:'+w+'px;height:'+w+'px;"><div style="width:'+w+'px;height:'+w+'px;" class="img-cover2 hide wrap-img-cover"><span class="loader loader-quart"></span></div><img id="'+file.id+'" src="" alt="商品图片" class="image"/><a href="javascript:;" class="icon-del hide"></a></li>');
